...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers Conference 2016 Typowalk · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1829">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers Conference 2016 Typowalk</h2>
     <h3><strong>*</strong> Typowalk cancelled <strong>*</strong></h3>
     <p class="note">Unfortunately we have had to cancel the typowalk due to our poor tourguide Jeroen having a dental emergency. We hope for your kind understanding!</p>
     <p>Are you in Amsterdam on the 5th of October? Join our typography expert <a href="http://www.twitter.com/vizinl">Jeroen Visser</a> on a unique (and <em>free!</em>) two hour walking tour through the city, and see Amsterdam in a different perspective!</p>
     ...
     <p class="figure full full-width"><img src="/_img/congres/2014/sideevent-iamsterdam-drawn.jpg" width="979" height="315" loading="lazy" decoding="async" alt="The Iamsterdam letters on the museumplein, in an illustration"></p>
     ...
     <p class="note">Can't make it? Please let us know via <a href="conference@fronteers.nl">conference@fronteers.nl</a>, so we can create an extra spot.</p>
    </div>
   </div>
   <div id="submenu">
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2016/fronteers-2016-typowalk" title="Fronteers Conference 2016 Typowalk" class="current">Typowalk (cancelled!)</a></li>
