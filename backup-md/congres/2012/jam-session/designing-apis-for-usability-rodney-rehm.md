...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Designing APIs for usability by Rodney Rehm · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p715">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Designing APIs for usability by Rodney Rehm</h2>
     <video width="640" height="360" controls>
      <source src="/_downloads/2012/rodney-rehm-designing-apis-for-usability.webm" type="video/webm">
      <source src="/_downloads/2012/rodney-rehm-designing-apis-for-usability.mp4" type="video/mp4">
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2012/rodney-rehm-designing-apis-for-usability.webm">download the video</a> (or the alternatives: <a href="/_downloads/2012/rodney-rehm-designing-apis-for-usability.mp4">1</a>) and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <p>Covering the 3 most important things one needs to consider when building utilities/libraries for others to use. (robustness, simplicity, flexibility)</p>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2012/jam-session/designing-apis-for-usability-rodney-rehm.md" id="comment">
      <fieldset>
