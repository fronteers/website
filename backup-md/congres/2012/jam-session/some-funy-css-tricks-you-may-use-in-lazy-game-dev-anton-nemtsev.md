...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Some funy css tricks you may use in lazy game dev by Anton Nemtsev · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p705">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Some funy css tricks you may use in lazy game dev by Anton Nemtsev</h2>
     <video width="640" height="360" controls>
      <source src="/_downloads/2012/anton-nemtsev-some-funny-tricks-you-may-use-in-lazy-game-dev.webm" type="video/webm">
      <source src="/_downloads/2012/anton-nemtsev-some-funny-tricks-you-may-use-in-lazy-game-dev.mp4" type="video/mp4">
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2012/anton-nemtsev-some-funny-tricks-you-may-use-in-lazy-game-dev.webm">download the video</a> (or the alternatives: <a href="/_downloads/2012/anton-nemtsev-some-funny-tricks-you-may-use-in-lazy-game-dev.mp4">1</a>) and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <p>Usually game development in web use flash, canvas or webgl. But today you may use also CSS with little bit of js. I want to show couple of tricks and explain why CSS sometimes may be good decision.</p>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2012/jam-session/some-funy-css-tricks-you-may-use-in-lazy-game-dev-anton-nemtsev.md" id="comment">
      <fieldset>
