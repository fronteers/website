...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>The Return of the Carriage Return by Jan van Hellemond · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p709">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>The Return of the Carriage Return by Jan van Hellemond</h2>
     <video width="640" height="360" controls>
      <source src="/_downloads/2012/jan-van-hellemond-the-return-of-the-carriage-return.webm" type="video/webm">
      <source src="/_downloads/2012/jan-van-hellemond-the-return-of-the-carriage-return.mp4" type="video/mp4">
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2012/jan-van-hellemond-the-return-of-the-carriage-return.webm">download the video</a> (or the alternatives: <a href="/_downloads/2012/jan-van-hellemond-the-return-of-the-carriage-return.mp4">1</a>) and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <p>How we were asked to build a continuous, full-screen, interactive animation for a client and the hilarity that ensued. A tale of feature detection, CSS animations and transitions, scripted animation, hardware acceleration and performance.</p>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2012/jam-session/the-return-of-the-carriage-return-jan-van-hellemond.md" id="comment">
      <fieldset>
