...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>CSS from scratch by Robbert Broersma · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p714">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>CSS from scratch by Robbert Broersma</h2>
     <video width="640" height="360" controls>
      <source src="/_downloads/2012/robbert-broersma-css-from-scratch.webm" type="video/webm">
      <source src="/_downloads/2012/robbert-broersma-css-from-scratch.mp4" type="video/mp4">
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2012/robbert-broersma-css-from-scratch.webm">download the video</a> (or the alternatives: <a href="/_downloads/2012/robbert-broersma-css-from-scratch.mp4">1</a>) and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <p>Implementing CSS in JavaScript in 10 easy steps</p>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2012/jam-session/css-from-scratch-robbert-broersma.md" id="comment">
      <fieldset>
