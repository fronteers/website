...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Concurrent Server-side JS on the JVM by Philipp Naderer · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p713">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Concurrent Server-side JS on the JVM by Philipp Naderer</h2>
     <video width="640" height="360" controls>
      <source src="/_downloads/2012/philipp-naderer-concurrent-server-side-js-on-the-jvm.webm" type="video/webm">
      <source src="/_downloads/2012/philipp-naderer-concurrent-server-side-js-on-the-jvm.mp4" type="video/mp4">
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2012/philipp-naderer-concurrent-server-side-js-on-the-jvm.webm">download the video</a> (or the alternatives: <a href="/_downloads/2012/philipp-naderer-concurrent-server-side-js-on-the-jvm.mp4">1</a>) and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <p>10 minutes about RingoJS, a Node.js-like CommonJS environment, which supports threaded JavaScript on the server (aka &quot;Workers&quot;).</p>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2012/jam-session/concurrent-server-side-js-on-the-jvm-philipp-naderer.md" id="comment">
      <fieldset>
