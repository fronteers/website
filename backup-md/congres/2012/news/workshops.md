...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Two workshops on the Wednesday before the conference (22-07-2012) · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p656">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Two workshops on the Wednesday before the conference (22-07-2012)</h2>
     <p>Just like previous Fronteers editions we'll be hosting two intensive, high quality, day long <a href="/congres/2012/workshops">workshops</a> prior to the conference. Unlike previous years both workshops will take place on the same day: Wednesday, 3 October.</p>
     <h3>Design and JavaScript</h3>
     <p>Mark Boulton will host a Visual Design 101 workshop for Web Developers and Addy Osmani will host one on JavaScript Application Development.</p>
     <p>We'll be adding more information to the <a href="/congres/2012/workshops">workshops page</a> as soon as possible.</p>
     <p>Both workshops will be given in Amsterdam, in English and they will take all day. To guarantee a personal atmosphere we have chosen to allow a maximum of 25 attendees so be sure to <a href="https://fronteers.paydro.net/">order your ticket</a> in time. There is a discount for members of Fronteers who became a member before the 5th of April, 2012 (your discount code arrived by email around that time).</p>
    </div>
   </div>
   <div id="submenu">
    <div>
