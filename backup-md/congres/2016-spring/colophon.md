...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers Spring Conference Team · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1619">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers Spring Conference Team</h2>
     <h3>Team</h3>
     <p>Fronteers Spring Conference is brought to you by:</p>
     <ul>
     ...
     <h3>About Fronteers Spring Conference</h3>
     <p>Fronteers Spring Conference is organised by volunteers of <a href="/about">Fronteers</a>, the Dutch trade organisation for front-end developers. Besides organising Fronteers Spring Conference, the trade organisation is known for organising Fronteers Conference (in October) and also runs regular meet-ups and workshops as well as an online job board. Fronteers has roughly 500 members, mainly in The Netherlands.</p>
    </div>
   </div>
   <div id="submenu">
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2016-spring/colophon" title="Fronteers Spring Conference Team" class="current">Team</a></li>
