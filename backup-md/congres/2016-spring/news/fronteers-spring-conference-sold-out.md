...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers Spring Conference sold out · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1687">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers Spring Conference sold out</h2>
     <p><em>Posted on March 30, 2016</em></p>
     <p>Tickets for the inaugural Fronteers Spring Conference have now sold out. Thank you so much!</p>
     <p>If you missed out, please <a href="/congres/2016-spring/contact">get in touch</a> and we will see if we can work something out, unpaid tickets might be made available.</p>
     <p>We're looking forward to welcoming you in Amsterdam this Friday!</p>
    </div>
   </div>
   <div id="submenu">
