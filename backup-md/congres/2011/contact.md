...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers 2011 contact information · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p405">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers 2011 contact information</h2>
     <p>If you have any questions about the Fronteers 2011 conference, send an e-mail to <a href="mailto:congres@fronteers.nl">congres@fronteers.nl</a>.</p>
     <p class="figure full-width bordered"><img src="/_img/congres/2010/fluff/pen.jpg" width="1024" height="409" loading="lazy" decoding="async" alt=""></p>
    </div>
   </div>
   <div id="submenu">
    <div>
    ...
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2011/contact" title="Fronteers 2011 contact information" class="current">Contact</a></li>
     </ul>
    </div>
    <div lang="en">
     <h2>Fronteers</h2>
