...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>More Early Birds and more speakers! (30-05-2011) · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p441">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>More Early Birds and more speakers! (30-05-2011)</h2>
     <p>We sold out of our 100 early bird tickets! Since we sold out much faster than we thought we decided to release 50 more early bird tickets for some more lucky people. We think these will sell out even faster, so buy yours now while they last, <a href="/congres/2011/tickets">prices will go up</a>. Does this make you happy? Not convinced to buy one? Read on.</p>
     <p>The line-up – <a href="/congres/2011/news/ticket-sales-started">which we liked already</a> – is extended by the following list of incredible speakers: the queen of the new revolution Divya Manian, the king of fool proof JavaScript Jake Archibald, the duke of Nordic walking Robert Nyman, the king of future CSS Stephen Hay and last but not least, the king of jQuery and soon to be Emperor of web education John Resig.</p>
     ...
     <dl id="comments" class="reacties">
      <dt id="comment-25"><a href="#comment-25" class="number">1</a> <a href="http://k1ngdom.net/">k1ng</a> on 30-05-2011 at 15:47 o'clock:</dt>
       <dd>John Resig did not retire from jquery, he left Mozilla. <br><br>Check your kingdom sources.</dd>
      <dt id="comment-26" class="odd"><a href="#comment-26" class="number" id="latest-comment">2</a> <a href="http://krijnhoetmer.nl/">Krijn</a> on 30-05-2011 at 16:11 o'clock:</dt>
       <dd class="odd">Fixed, sorry about that! :)</dd>
     </dl>
     <form method="post" action="/congres/2011/news/more-early-birds-and-more-speakers.md" id="comment">
      <fieldset>
