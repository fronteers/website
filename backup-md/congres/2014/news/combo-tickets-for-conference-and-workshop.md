...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Combo tickets for conference + workshop · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1195">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Combo tickets for conference + workshop</h2>
     <p>As you probably know Rachel Nabors and Kyle Simpson will host workshops on Wednesday 8 October. Rachel’s workshop will be about <a href="/congres/2014/workshops/workshop-animation-rachel-nabors">web animation with CSS and HTML5</a>. Kyle’s workshop will teach you all you need to know about <a href="/congres/2014/workshops/workshop-real-time-html5-nodejs-kyle-simpson">real-time communications, using HTML5 APIs and Node.js</a>.</p>
     <p>Recently we started the sales for the regular Fronteers 2014 workshops tickets. And since we’ve kept some conference tickets aside, we’re happy to announce that sales of a limited number of combo tickets, for both conference and workshop, will start on Wednesday 30 July at 12:00 CEST!</p>
     <p>Combo tickets cost €710,- (€560,- for Fronteers members, see newsletter from 25 April for how to get the discount) and give you access to both the conference and the workshop.</p>
