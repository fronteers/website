...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Ceci n'est pas une pipe by Wilfred Nas · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1281">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Ceci n'est pas une pipe by Wilfred Nas</h2>
     <p>Wilfred talks about proper names for CSS selectors and why you should bother with them. He also covers a bit of CSS3 selectors that can help you with working with these names and namespaces.</p>
     <iframe src="//player.vimeo.com/video/113493699" width="600" height="337" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
    </div>
   </div>
   <div id="submenu">
