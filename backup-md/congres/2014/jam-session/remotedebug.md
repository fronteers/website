...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>RemoteDebug everything! by Kenneth Auchenberg · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1282">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>RemoteDebug everything! by Kenneth Auchenberg</h2>
     <p>The future of web tooling is powered by remote debugging. RemoteDebug everything!</p>
     <iframe src="//player.vimeo.com/video/113493805" width="600" height="337" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
    </div>
   </div>
   <div id="submenu">
