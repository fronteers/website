...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Functional Testing for Dummies by Menno van Slooten · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1279">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Functional Testing for Dummies by Menno van Slooten</h2>
     <p>Automating functional tests for websites is a pain in the ass. Tests often end up being brittle, hard to write and don't accurately simulate user behavior.</p>
     <p>DummyJS is here to change that. It is intended for web developers that want to spend less time on writing, running and maintaining E2E tests. It's not meant as a replacement of tools like CasperJS and Selenium but as an alternative that does 80% of what they do in 20% of the time.</p>
     <iframe src="//player.vimeo.com/video/113493799" width="600" height="337" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
    </div>
   </div>
   <div id="submenu">
