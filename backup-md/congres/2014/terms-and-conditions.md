...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers 2014 Terms and conditions conference and workshops · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1113">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers 2014 Terms and conditions conference and workshops</h2>
     <h3>Acceptance</h3>
     <ul>
      <li>By purchasing a ticket for Fronteers conference and/or a workshop you accept these Terms and Conditions in full.</li>
     </ul>
     <h3>Pricing</h3>
     <ul>
      <li>All prices are subject to errors. Fronteers can not be held accountable due to any errors.</li>
      <li>All prices are in Euros and exclude Dutch VAT of 21%.</li>
     </ul>
     <h3>Payment provider and payment options</h3>
     <ul>
      <li>Fronteers uses the services offered by Paydro to sell tickets.</li>
      <li>It is possible to pay by credit card or other online payment method as offered by Paydro.</li>
     </ul>
     ...
     <ul>
      <li>A ticket to a Fronteers workshop grants entrance to the workshop it was purchased for, lunch, coffee, tea and snacks on the day of the workshop. A ticket to a Fronteers workshop does <em>not</em> grant access to the conference. Fo this a separate ticket to the conference must be purchased.</li>
      <li>Attendees are responsible for their own traval and accommodation.</li>
     </ul>
     <h3>Member tickets</h3>
     <ul>
     ...
     <h3>Restitution</h3>
     <ul>
      <li>A ticket to either the conference or a workshop is final and non-refundable once purchased.</li>
     </ul>
     <h3>Transferring a ticket</h3>
     <ul>
      <li>Conference and workshop tickets can always be transferred.</li>
      <li>It is possible to notify the organisation of any changes to your registration up until two weeks before the conference or workshop. After that, tickets are still transferrable but the person who will attend in your place will get a badge with your name on it.</li>
      <li>Your request to change must include your email address and that of the person who will attend in your place.</li>
      <li>Member tickets can <em>not</em> be transferred to non-members.</li>
     </ul>
     <h3>Speakers and schedule</h3>
     <ul>
     ...
     <h3>Cancellation of the conference or a workshop</h3>
     <ul>
