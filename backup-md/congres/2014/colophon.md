...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers 2014 colophon · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p978">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers 2014 colophon</h2>
     <h3>Team</h3>
     <p>Fronteers 2014 will be brought to you by a team of 6. And these are the people to <del>blame or</del> praise:</p>
     <ul>
      <li>Charis Rooda (chair, speakers, after party)</li>
      <li>Jan van Hellemond (video, attendees, book raffle)</li>
      <li>Flurin Egger (speakers, marketing)</li>
      <li>Michael Hastrich (graphic design, runners, workshops, book raffle)</li>
      <li>Sander Aarts (a/v, wifi, venue, workshops)</li>
      <li>Thomas van Zuijlen (finance, catering, jam session, volunteers)</li>
     </ul>
   ...
   <div id="submenu">
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2014/colophon" title="Fronteers 2014 colophon" class="current">Colophon</a></li>
