...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Workshop Advanced CSS styling by Andy Clarke · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p267">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Workshop Advanced CSS styling by Andy Clarke</h2>
     <ul>
      <li>When: Wednesday October 6, 2010</li>
      <li>Where: <a href="/congres/2010/workshops#venue">Felix Meritis, Kremlin room</a></li>
     </ul>
     ...
     <p>‘Advanced CSS Styling’; is a unique one-day master class presented by Andy Clarke, designer and author of the best-selling <a href="http://transcendingcss.com/">Transcending CSS</a>. Spend the day with Andy learning how to use the most up-to-date CSS techniques in your everyday work.</p>
     ...
     <h3 id="schedule">Schedule (<em>subject to change</em>)</h3>
     <h4>8.30am – 9.00am: Registration</h4>
     <ul>
      <li>Register, get settled and enjoy a cup of coffee with your fellow attendees.</li>
     </ul>
     <h4>9.00am – 10:30am: Introduction</h4>
     <ul>
     ...
     <h4>10:30 – 11:00: Break</h4>
     <h4>11:00am – 12:30am: New ways to work with colour using RGBa and Opacity.</h4>
     <ul>
      <li>Using multiple background and border images.</li>
      <li>How to use text and box shadows.</li>
     ...
     <h4>12:30am – 1:30pm: Lunch</h4>
     <h4>1:30pm – 3:00pm: Javascript and progressive enrichment</h4>
     <ul>
     ...
     <h4>3:00pm – 3:30pm: Break</h4>
     <ul>
      <li>Tea, coffee or a soda</li>
     </ul>
     <h4>3:30pm – 5:30pm: <code>@font-face</code> font embedding and typography</h4>
     <ul>
      <li>Creating striking, readable type with typographic hierarchies.</li>
      <li>How to improve typography with kerning, leading and baseline shifts.</li>
      <li>Working with font embedding solutions including Typekit, Kernest and Cufon.</li>
     ...
     <h4>6:30pm – late: Evening social</h4>
     <ul>
      <li>A further opportunity for you to network with your fellow attendees.</li>
     </ul>
    </div>
   </div>
   <div id="submenu">
