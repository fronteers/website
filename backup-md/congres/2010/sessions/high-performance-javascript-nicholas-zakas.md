...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>High Performance JavaScript by Nicholas Zakas · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p338">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>High Performance JavaScript by Nicholas Zakas</h2>
     <h3>Videos</h3>
     <video width="480" height="270" src="/_downloads/2010/nicholas-zakas-high-performance-javascript.webm" controls>
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2010/nicholas-zakas-high-performance-javascript.webm">download the video</a> and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <ul>
      <li><a href="http://vimeo.com/16241085">Watch high quality video on Vimeo</a></li>
      <li><a href="/_downloads/2010/nicholas-zakas-high-performance-javascript.webm">Download video</a> (WebM, 158MB)</li>
      <li><a href="/_downloads/2010/nicholas-zakas-high-performance-javascript.ogv">Download video</a> (OGV, 64MB)</li>
     </ul>
     <h3>Slides</h3>
     <iframe src="https://www.slideshare.net/slideshow/embed_code/5393226" width="427" height="356" allowfullscreen></iframe>
     <ul>
      <li><a href="http://www.slideshare.net/nzakas/high-performance-javascript-fronteers-2010">See slides on SlideShare</a></li>
      <li><a href="/_downloads/2010/nicholas-zakas-high-performance-javascript.pdf">Download slides</a> (PDF, 5MB)</li>
     </ul>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2010/sessions/high-performance-javascript-nicholas-zakas.md" id="comment">
      <fieldset>
   ...
   <div id="submenu">
    ...
    <div lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2010/sessions/high-performance-javascript-nicholas-zakas" class="current">High Performance JavaScript by Nicholas Zakas</a></li>
