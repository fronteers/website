...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Creating lifelike designs with CSS3 by Meagan Fisher · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p336">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Creating lifelike designs with CSS3 by Meagan Fisher</h2>
     <h3>Video</h3>
     <video width="480" height="270" src="/_downloads/2010/meagan-fisher-creating-lifelike-designs-with-css3.webm" controls>
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2010/meagan-fisher-creating-lifelike-designs-with-css3.webm">download the video</a> and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <ul>
      <li><a href="http://vimeo.com/15991551">Watch high quality video on Vimeo</a></li>
      <li><a href="/_downloads/2010/meagan-fisher-creating-lifelike-designs-with-css3.webm">Download video</a> (WebM, 107MB)</li>
      <li><a href="/_downloads/2010/meagan-fisher-creating-lifelike-designs-with-css3.ogv">Download video</a> (OGV, 42MB)</li>
     </ul>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2010/sessions/creating-lifelike-designs-with-css3-meagan-fisher.md" id="comment">
      <fieldset>
   ...
   <div id="submenu">
    ...
    <div lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2010/sessions/creating-lifelike-designs-with-css3-meagan-fisher" class="current">Creating lifelike designs with CSS3 by Meagan Fisher</a></li>
