...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>The Renaissance of Browser Animation by Cameron Adams · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p345">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>The Renaissance of Browser Animation by Cameron Adams</h2>
     <h3>Videos</h3>
     <video width="480" height="270" src="/_downloads/2010/cameron-adams-renaissance-of-browser-animation.webm" controls>
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2010/cameron-adams-renaissance-of-browser-animation.webm">download the video</a> and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <ul>
      <li><a href="http://vimeo.com/16246110">Watch high quality video on Vimeo</a></li>
      <li><a href="/_downloads/2010/cameron-adams-renaissance-of-browser-animation.webm">Download video</a> (WebM, 167MB)</li>
      <li><a href="/_downloads/2010/cameron-adams-renaissance-of-browser-animation.ogv">Download video</a> (OGV, 83MB)</li>
     </ul>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2010/sessions/the-renaissance-of-browser-animation-cameron-adams.md" id="comment">
      <fieldset>
   ...
   <div id="submenu">
    ...
    <div lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2010/sessions/the-renaissance-of-browser-animation-cameron-adams" class="current">The Renaissance of Browser Animation by Cameron Adams</a></li>
