...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Real-world Responsive Design by Stephen Hay · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p342">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Real-world Responsive Design by Stephen Hay</h2>
     <h3>Videos</h3>
     <video width="480" height="270" src="/_downloads/2010/stephen-hay-real-world-responsive-design.webm" controls>
      <p>The <code>&lt;video></code> element is not (yet) supported in your browser; you can <a href="/_downloads/2010/stephen-hay-real-world-responsive-design.webm">download the video</a> and watch it with <a href="http://www.videolan.org/vlc/">VLC</a>, for example.</p>
     </video>
     <ul>
      <li><a href="http://vimeo.com/15986231">Watch high quality video on Vimeo</a></li>
      <li><a href="/_downloads/2010/stephen-hay-real-world-responsive-design.webm">Download video</a> (WebM, 143MB)</li>
      <li><a href="/_downloads/2010/stephen-hay-real-world-responsive-design.ogv">Download video</a> (OGV, 62MB)</li>
     </ul>
     <h3>Slides</h3>
     <iframe src="https://www.slideshare.net/slideshow/embed_code/5406746" width="427" height="356" allowfullscreen></iframe>
     <ul>
      <li><a href="http://www.slideshare.net/stephenhay/realworld-responsive-design">See slides on SlideShare</a></li>
      <li><a href="/_downloads/2010/stephen-hay-real-world-responsive-design.pdf">Download slides</a> (PDF, 6MB)</li>
     </ul>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2010/sessions/real-world-responsive-design-stephen-hay.md" id="comment">
      <fieldset>
   ...
   <div id="submenu">
    ...
    <div lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2010/sessions/real-world-responsive-design-stephen-hay" class="current">Real-world Responsive Design by Stephen Hay</a></li>
