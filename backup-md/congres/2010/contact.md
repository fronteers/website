...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers 2010 contact information · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p252">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers 2010 contact information</h2>
     <p>If you have any questions about the Fronteers conference, send an e-mail to <a href="mailto:congres@fronteers.nl">congres@fronteers.nl</a>.</p>
   ...
   <div id="submenu">
    ...
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2010/contact" title="Fronteers 2010 contact information" class="current">Contact</a></li>
     </ul>
    </div>
    <div lang="en">
     <h2>All sessions</h2>
