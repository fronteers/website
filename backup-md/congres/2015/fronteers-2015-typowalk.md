...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers 2015 typowalk · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1488">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers 2015 typowalk</h2>
     <p>Are you in Amsterdam on the 7th of October? Join our typography expert <a href="http://www.twitter.com/vizinl">Jeroen Visser</a> on a unique (and <em>free!</em>) two hour walking tour through the city, and see Amsterdam in a different perspective!</p>
     <p>Find out what is special about the bridges in Amsterdam, how type can work wonders on buildings, and what makes type wonderful in the cityscape. Or dreadful, in some cases.</p>
     <p>The typowalk is curated and presented by <a href="http://www.twitter.com/vizinl">Jeroen Visser</a>, a web savvy type nerd, who’s also responsible for Fronteers’ web typography workshop ‘counterspace’.</p>
     <p><strong>Due to the overwhelming interest in the Typowalk, we have asked Jeroen to give an extra tour in the morning! This tour will take the same route through Amsterdam as the one that starts at 15.00. Please sign up using the form below if you want to join us!</strong></p>
     <p class="figure full full-width"><img src="/_img/congres/2015/jeroenvisser-typowalk.png" width="806" height="260" loading="lazy" decoding="async" alt=""></p>
     <ul>
      <li><strong>Date:</strong> Wednesday October 7, the day before...</li>
      <li><strong>Time:</strong> The first Typowalk starts at 11.00 (and ends around 13.00), the second Typowalk starts at 15:00 and ends at 17:00. In total, the tour will take 2 hours.</li>
      <li><strong>Location:</strong> Pathé Tuschinski, <a href="http://maps.google.com/maps?q=Reguliersbreestraat+34,+1017+CN+Binnenstad,+Amsterdam,+Nederland">Reguliersbreestraat 26-34, 1017 CN, Amsterdam</a></li>
      <li><strong>Cost:</strong> Free, but please make sure to sign up for the walk below. If it turns out later you can't make it, please let us know via <a href="congres@fronteers.nl">congres@fronteers.nl</a> so we can create an extra spot.</li>
      <li><strong>Autumn weather?</strong> Leave your umbrella at home! We will provide you with a nice poncho when rain is expected.</li>
     </ul>
     <form action="/congres/2015/fronteers-2015-typowalk.md#formulier-1" method="post" id="formulier-1" class="generated">
      <fieldset>
       <legend>Register for the Typowalk on October 7 at 11:00</legend>
       ...
       <p class="form-element">
        <label for="form-1-input-3" class="form-label">Remarks</label>
        <textarea name="Remarks" id="form-1-input-3" cols="50" rows="5" class="small"></textarea>
       </p>
       <p class="form-element">
       ...
       <p class="submit">
        ...
        <input type="hidden" name="hsh" value="d66e049ba2c427f714e9a23b6a58f268">
        <input type="hidden" name="ref" value="">
        <input type="submit" name="submitted" value="Send" class="submit form-submit">
       </p>
      </fieldset>
     </form>
     <p class="note">Can't make it? Please let us know via <a href="congres@fronteers.nl">congres@fronteers.nl</a>, so we can create an extra spot.</p>
     <h4>Signups for the Typowalk at 11.00</h4>
     <p>(Hidden to protect the privacy of participants)</p>
     <h4>Signups for the Typowalk at 15.00</h4>
     <p>(Hidden to protect the privacy of participants)</p>
    </div>
   </div>
   <div id="submenu">
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2015/fronteers-2015-typowalk" title="Fronteers 2015 typowalk" class="current">Typowalk</a></li>
