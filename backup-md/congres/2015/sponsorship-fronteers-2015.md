...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers 2015 Sponsorship · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1489">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers 2015 Sponsorship</h2>
     <p><a href="/congres/2015">Fronteers conference</a> is a two day web conference for front-end developers, held each year in Amsterdam, the Netherlands, at the beautiful Tuschinski theatre. We proudly welcome over 500 attendees each year from all over the world; expert, intermediate, and beginner front-end developers. During the conference 18 high-profile international speakers discuss the latest techniques and concepts in front-end web development. This year's edition is on Thursday and Friday, October 8-9, 2015.</p>
     <p>Fronteers is open to sponsoring. The right sponsors can allow us to better serve our attendees and to further improve the quality of the conference. We have two sponsorship packages available:</p>
     <h4>Fronteers 2015 Gold Sponsor (€1000)</h4>
     <ul>
      <li>One badge, allowing access to both conference days</li>
      <li>Space in our attendee goodie bag for your (cool!) gadgets or goodies</li>
      <li>Your company logo stated on screen during the conference and <a href="/congres/2015/jam-session">Jam Session</a></li>
     </ul>
     <h4>Fronteers 2015 Platinum Sponsor (€2000)</h4>
     <ul>
      <li>Two badges, allowing access to both conference days</li>
      <li>Space in our attendee goodie bag for your (cool!) gadgets or goodies</li>
      <li>Your company logo stated on screen during the conference and <a href="/congres/2015/jam-session">Jam Session</a></li>
      <li>Your company logo on all the conference badges</li>
     </ul>
     <p class="note">We offer a limited number of Platinum Sponsor packages to prevent an overly crowded attendees' badge. Your company logo deserves proper attention and our attendees deserve better than a printed Million Dollar Homepage around their necks.</p>
     <p>For more information or to sign up, please contact <strong>Sander Vink</strong>, our Sponsorship representative, at +31 6 39 75 01 26 or <a href="mailto:sander.vink@fronteers.nl">sander.vink@fronteers.nl</a></p>
    </div>
   </div>
   <div id="submenu">
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2015/sponsorship-fronteers-2015" title="Fronteers 2015 Sponsorship" class="current">Sponsorship</a></li>
