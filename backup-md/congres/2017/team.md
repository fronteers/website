...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title lang="en">Fronteers Conference 2017 Team · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p2018">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers Conference 2017 Team</h2>
     <ul>
      <li>Anneke Sinnema</li>
      <li>Job van Achterberg</li>
      <li>Paul van Buuren</li>
      <li>Paul Verbeek-Mast</li>
      <li>Tom Hartwig</li>
      <li>Thijs Reijersberg</li>
   ...
   <div id="submenu">
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2017/team" title="Fronteers Conference 2017 Team" class="current">Team</a></li>
