...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title lang="en">Diversity tickets for Fronteers Conference 2017 · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p2020">
  <style>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Diversity tickets for Fronteers Conference 2017</h2>
     <p>Fronteers has made 15 diversity tickets available for Fronteers Conference 2017, for a discounted price of €50! The tickets are available for everyone who's part of an underrepresented group in tech. This includes, but is not limited to: women, people of colour, LGBTQ people, disabled people, and people facing economic or social hardships.</p>
     <p>Because we value your privacy and understand how hard it can be for some of you to talk about the reason you apply, we only ask you for your name and email address.</p>
     <p class="figure padded side"><img src="/_img/congres/2017/diversity-full.png" width="800" height="165" loading="lazy" decoding="async" alt=""></p>
    </div>
    <div class="section odd" lang="en">
     <p>Please apply for the tickets through <a href="conference@fronteers.nl">conference@fronteers.nl</a>. The deadline is September 3rd. After that 15 people will be randomly selected through a lottery and will be contacted through their submitted email address with a special URL to buy their ticket.</p>
    </div>
   </div>
   <div id="submenu">
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2017/diversity-tickets" title="Diversity tickets for Fronteers Conference 2017" class="current">Diversity tickets</a></li>
