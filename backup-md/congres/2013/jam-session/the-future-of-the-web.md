...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>The future of the web by Eric Eggert · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1035">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>The future of the web by Eric Eggert</h2>
     <iframe src="//player.vimeo.com/video/77929467" width="600" height="337" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2013/jam-session/the-future-of-the-web.md" id="comment">
      <fieldset>
