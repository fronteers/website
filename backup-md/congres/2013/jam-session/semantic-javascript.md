...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Semantic JavaScript: Beyond Frameworks, Beyond DOM by Max Shirshin · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p1039">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Semantic JavaScript: Beyond Frameworks, Beyond DOM by Max Shirshin</h2>
     <iframe src="//player.vimeo.com/video/77575075" width="600" height="337" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
     <ul class="post options">
      <li><a href="#comments" id="goto-comments"><strong>0</strong> comments</a></li>
      <li><a href="#comment" id="goto-comment">Comment</a></li>
     </ul>
     <form method="post" action="/congres/2013/jam-session/semantic-javascript.md" id="comment">
      <fieldset>
