...
<html lang="nl">
 <head>
  <meta charset="utf-8">
  <title>Fronteers 2013 contact information · Fronteers</title>
  ...
  <link rel="shortlink" href="http://frnt.rs/p805">
 </head>
  ...
  <div id="container">
   <div id="main">
    ...
    <div class="section" lang="en">
     <h2>Fronteers 2013 contact information</h2>
     <p>Should you have any questions about the Fronteers 2013 conference, tickets, payments or invoices, please use the following contact form, or send an e-mail to <a href="mailto:congres@fronteers.nl">congres@fronteers.nl</a>.</p>
     <form action="/congres/2013/contact.md#formulier-1" method="post" id="formulier-1" class="generated">
      <fieldset>
       <legend>Question about Fronteers 2013</legend>
       ...
       <p class="submit">
        ...
        <input type="hidden" name="hsh" value="7e6eaf74faaa6440cfa2ccbf14527041">
   ...
   <div id="submenu">
    ...
    <div id="conference-menu" lang="en">
     ...
     <ul>
      ...
      <li class="current"><a href="/congres/2013/contact" title="Fronteers 2013 contact information" class="current">Contact information</a></li>
     </ul>
    </div>
    <div lang="en">
     <h2>Elsewhere</h2>
